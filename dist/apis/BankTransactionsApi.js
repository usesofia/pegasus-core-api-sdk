...
var BankTransactionsApi = /** @class */ (function (_super) {
     ...
     * Busca sugestões de AI por ID do lançamento financeiro.
     */
    BankTransactionsApi.prototype.findAiSuggestionsByFinancialRecordId = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.findAiSuggestionsByFinancialRecordIdRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                if (requestParameters['providerTransactionId'] == null) {
                    throw new runtime.RequiredError('providerTransactionId', 'Required parameter "providerTransactionId" was null or undefined when calling systemRemoveBankTransaction().');
                }
                if (requestParameters['ownerOrganizationId'] == null) {
                ...
                headerParameters = {};
                urlPath = "/internal/bank-transactions/{providerTransactionId}";
                urlPath = urlPath.replace("{".concat("providerTransactionId", "}"), encodeURIComponent(String(requestParameters['providerTransactionId'])));
                return [2 /*return*/, {
                        path: urlPath,
                        method: 'DELETE',
                        headers: headerParameters,
