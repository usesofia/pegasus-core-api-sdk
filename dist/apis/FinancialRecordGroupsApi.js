...
exports.FinancialRecordGroupsApi = void 0;
var runtime = require("../runtime");
var index_1 = require("../models/index");
/**
 *
 */
var FinancialRecordGroupsApi = /** @class */ (function (_super) {
    __extends(FinancialRecordGroupsApi, _super);
    function FinancialRecordGroupsApi() {
     ...
     * Busca grupos de lançamentos financeiros pelo ID do lançamento.
     */
    FinancialRecordGroupsApi.prototype.findFinancialRecordGroupsByFinancialRecord = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.findFinancialRecordGroupsByFinancialRecordRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
    ...
    return FinancialRecordGroupsApi;
}(runtime.BaseAPI));
exports.FinancialRecordGroupsApi = FinancialRecordGroupsApi;
