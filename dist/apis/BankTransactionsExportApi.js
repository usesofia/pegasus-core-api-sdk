...
exports.ExportBankTransactionsFormatEnum = exports.ExportBankTransactionsTypeEnum = exports.ExportBankTransactionsOriginEnum = exports.ExportBankTransactionsSortByEnum = exports.ExportBankTransactionsSortOrderEnum = exports.BankTransactionsExportApi = void 0;
var runtime = require("../runtime");
var index_1 = require("../models/index");
/**
 *
 */
var BankTransactionsExportApi = /** @class */ (function (_super) {
    __extends(BankTransactionsExportApi, _super);
    function BankTransactionsExportApi() {
     ...
     * Solicita a exportação das transações bancárias.
     */
    BankTransactionsExportApi.prototype.exportBankTransactions = function () {
        return __awaiter(this, arguments, void 0, function (requestParameters, initOverrides) {
            var response;
            if (requestParameters === void 0) { requestParameters = {}; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.exportBankTransactionsRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
    ...
    return BankTransactionsExportApi;
}(runtime.BaseAPI));
exports.BankTransactionsExportApi = BankTransactionsExportApi;
/**
 * @export
 */
exports.ExportBankTransactionsSortOrderEnum = {
    Asc: 'asc',
    Desc: 'desc'
};
/**
 * @export
 */
exports.ExportBankTransactionsSortByEnum = {
    Date: 'date',
 ...
 * @export
 */
exports.ExportBankTransactionsOriginEnum = {
 ...
 * @export
 */
exports.ExportBankTransactionsTypeEnum = {
    Debit: 'DEBIT',
    Credit: 'CREDIT'
};
/**
 * @export
 */
exports.ExportBankTransactionsFormatEnum = {
    Csv: 'csv',
    Xlsx: 'xlsx'
};
