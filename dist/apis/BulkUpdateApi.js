...
exports.BulkUpdateApi = void 0;
var runtime = require("../runtime");
var index_1 = require("../models/index");
/**
 *
 */
var BulkUpdateApi = /** @class */ (function (_super) {
     ...
     * Processes bulk update tasks
     */
    BulkUpdateApi.prototype.processBulkUpdate = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.processBulkUpdateRaw(requestParameters, initOverrides)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
     ...
     * Schedules updating of multiple resources
     */
    BulkUpdateApi.prototype.scheduleBulkUpdate = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.scheduleBulkUpdateRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
