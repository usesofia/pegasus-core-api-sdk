...
exports.ExportResourceJobRequestsApi = void 0;
var runtime = require("../runtime");
var index_1 = require("../models/index");
/**
 *
 */
var ExportResourceJobRequestsApi = /** @class */ (function (_super) {
    __extends(ExportResourceJobRequestsApi, _super);
    function ExportResourceJobRequestsApi() {
     ...
     * Processa a exportação de um recurso.
     */
    ExportResourceJobRequestsApi.prototype.processExportResourceJobRequest = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.processExportResourceJobRequestRaw(requestParameters, initOverrides)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    return ExportResourceJobRequestsApi;
}(runtime.BaseAPI));
exports.ExportResourceJobRequestsApi = ExportResourceJobRequestsApi;
