 ...
 *
 */
var InstallmentFinancialRecordsExportApi = /** @class */ (function (_super) {
    __extends(InstallmentFinancialRecordsExportApi, _super);
    function InstallmentFinancialRecordsExportApi() {
     ...
     * Solicita a exportação dos lançamentos financeiros parcelados.
     */
    InstallmentFinancialRecordsExportApi.prototype.exportInstallmentFinancialRecords = function () {
        return __awaiter(this, arguments, void 0, function (requestParameters, initOverrides) {
            var response;
            if (requestParameters === void 0) { requestParameters = {}; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.exportInstallmentFinancialRecordsRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
