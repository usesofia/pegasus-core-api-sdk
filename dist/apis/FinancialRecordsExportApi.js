 ...
 *
 */
var FinancialRecordsExportApi = /** @class */ (function (_super) {
    __extends(FinancialRecordsExportApi, _super);
    function FinancialRecordsExportApi() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    /**
     * Creates request options for exportFinancialRecords without sending the request
     */
    FinancialRecordsExportApi.prototype.exportFinancialRecordsRequestOpts = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                headerParameters = {};
                urlPath = "/external/financial-records/export";
                return [2 /*return*/, {
                        path: urlPath,
                        method: 'POST',
     ...
     */
    FinancialRecordsExportApi.prototype.exportFinancialRecordsRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var requestOptions, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.exportFinancialRecordsRequestOpts(requestParameters)];
                    case 1:
                        requestOptions = _a.sent();
                        return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                    case 2:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, index_1.ExportFinancialRecordsDtoFromJSON)(jsonValue); })];
                }
            });
        });
    };
     ...
     * Solicita a exportação dos lançamentos financeiros.
     */
    FinancialRecordsExportApi.prototype.exportFinancialRecords = function () {
        return __awaiter(this, arguments, void 0, function (requestParameters, initOverrides) {
            var response;
            if (requestParameters === void 0) { requestParameters = {}; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.exportFinancialRecordsRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
 ...
 * @export
 */
exports.ExportFinancialRecordsFormatEnum = {
    Csv: 'csv',
    Xlsx: 'xlsx'
};
