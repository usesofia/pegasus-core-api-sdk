...
exports.FindAllCustomersSortByEnum = exports.FindAllCustomersSortOrderEnum = exports.CustomersApi = void 0;
...
var CustomersApi = /** @class */ (function (_super) {
     ...
     * Create a new customer.
     */
    CustomersApi.prototype.createCustomer = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * Lista todos os customers com paginação e filtros.
     */
    CustomersApi.prototype.findAllCustomers = function () {
        return __awaiter(this, arguments, void 0, function (requestParameters, initOverrides) {
            var response;
            if (requestParameters === void 0) { requestParameters = {}; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.findAllCustomersRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
     ...
     * Busca um customer pelo identificador.
     */
    CustomersApi.prototype.findByIdCustomer = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.findByIdCustomerRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
     ...
     * Partially update a customer.
     */
    CustomersApi.prototype.partialUpdateCustomer = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.partialUpdateCustomerRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
 ...
 * @export
 */
exports.FindAllCustomersSortOrderEnum = {
    Asc: 'asc',
    Desc: 'desc'
};
/**
