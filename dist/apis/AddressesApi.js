...
var AddressesApi = /** @class */ (function (_super) {
     ...
     * Busca todos os países.
     */
    AddressesApi.prototype.findAllCountries = function (initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.findAllCountriesRaw(initOverrides)];
                    case 1:
                        response = _a.sent();
     ...
     * Busca todos os estados de um país.
     */
    AddressesApi.prototype.findStatesByCountry = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.findStatesByCountryRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
