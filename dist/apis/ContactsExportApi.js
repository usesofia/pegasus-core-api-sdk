 ...
 *
 */
var ContactsExportApi = /** @class */ (function (_super) {
    __extends(ContactsExportApi, _super);
    function ContactsExportApi() {
     ...
     * Solicita a exportação dos contatos.
     */
    ContactsExportApi.prototype.exportContacts = function () {
        return __awaiter(this, arguments, void 0, function (requestParameters, initOverrides) {
            var response;
            if (requestParameters === void 0) { requestParameters = {}; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.exportContactsRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
 ...
 * @export
 */
exports.ExportContactsFormatEnum = {
    Csv: 'csv',
    Xlsx: 'xlsx'
};
