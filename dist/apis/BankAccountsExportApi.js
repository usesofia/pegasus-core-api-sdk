 ...
 *
 */
var BankAccountsExportApi = /** @class */ (function (_super) {
    __extends(BankAccountsExportApi, _super);
    function BankAccountsExportApi() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    /**
     * Creates request options for exportBankAccounts without sending the request
     */
    BankAccountsExportApi.prototype.exportBankAccountsRequestOpts = function (requestParameters) {
    ...
    BankAccountsExportApi.prototype.exportBankAccountsRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.exportBankAccountsRequestOpts(requestParameters)];
                    case 1:
                        requestOptions = _a.sent();
                        return [4 /*yield*/, this.request(requestOptions, initOverrides)];
                    case 2:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, index_1.ExportBankAccountsDtoFromJSON)(jsonValue); })];
                }
            });
        });
    };
     ...
     * Solicita a exportação das contas bancárias.
     */
    BankAccountsExportApi.prototype.exportBankAccounts = function () {
        return __awaiter(this, arguments, void 0, function (requestParameters, initOverrides) {
            var response;
            if (requestParameters === void 0) { requestParameters = {}; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.exportBankAccountsRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
 ...
 * @export
 */
exports.ExportBankAccountsFormatEnum = {
    Csv: 'csv',
    Xlsx: 'xlsx'
};
