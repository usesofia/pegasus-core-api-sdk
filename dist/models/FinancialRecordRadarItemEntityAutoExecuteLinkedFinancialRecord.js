...
exports.FinancialRecordRadarItemEntityAutoExecuteLinkedFinancialRecordDirectionEnum = void 0;
exports.instanceOfFinancialRecordRadarItemEntityAutoExecuteLinkedFinancialRecord = instanceOfFinancialRecordRadarItemEntityAutoExecuteLinkedFinancialRecord;
exports.FinancialRecordRadarItemEntityAutoExecuteLinkedFinancialRecordFromJSON = FinancialRecordRadarItemEntityAutoExecuteLinkedFinancialRecordFromJSON;
exports.FinancialRecordRadarItemEntityAutoExecuteLinkedFinancialRecordFromJSONTyped = FinancialRecordRadarItemEntityAutoExecuteLinkedFinancialRecordFromJSONTyped;
exports.FinancialRecordRadarItemEntityAutoExecuteLinkedFinancialRecordToJSON = FinancialRecordRadarItemEntityAutoExecuteLinkedFinancialRecordToJSON;
exports.FinancialRecordRadarItemEntityAutoExecuteLinkedFinancialRecordToJSONTyped = FinancialRecordRadarItemEntityAutoExecuteLinkedFinancialRecordToJSONTyped;
 ...
 * @export
 */
exports.FinancialRecordRadarItemEntityAutoExecuteLinkedFinancialRecordDirectionEnum = {
    In: 'IN',
    Out: 'OUT'
};
/**
 ...
 */
function instanceOfFinancialRecordRadarItemEntityAutoExecuteLinkedFinancialRecord(value) {
...
function FinancialRecordRadarItemEntityAutoExecuteLinkedFinancialRecordFromJSON(json) {
    return FinancialRecordRadarItemEntityAutoExecuteLinkedFinancialRecordFromJSONTyped(json, false);
}
function FinancialRecordRadarItemEntityAutoExecuteLinkedFinancialRecordFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function FinancialRecordRadarItemEntityAutoExecuteLinkedFinancialRecordToJSON(json) {
    return FinancialRecordRadarItemEntityAutoExecuteLinkedFinancialRecordToJSONTyped(json, false);
}
function FinancialRecordRadarItemEntityAutoExecuteLinkedFinancialRecordToJSONTyped(value, ignoreDiscriminator) {
