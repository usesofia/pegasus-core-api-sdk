...
exports.CreateOrUpdateBankTransactionRequestBodyDtoStatusEnum = exports.CreateOrUpdateBankTransactionRequestBodyDtoTypeEnum = exports.CreateOrUpdateBankTransactionRequestBodyDtoProviderEnum = void 0;
exports.instanceOfCreateOrUpdateBankTransactionRequestBodyDto = instanceOfCreateOrUpdateBankTransactionRequestBodyDto;
exports.CreateOrUpdateBankTransactionRequestBodyDtoFromJSON = CreateOrUpdateBankTransactionRequestBodyDtoFromJSON;
 ...
 * @export
 */
exports.CreateOrUpdateBankTransactionRequestBodyDtoProviderEnum = {
    Pluggy: 'PLUGGY',
    Ofx: 'OFX',
    Other: 'OTHER'
};
 ...
 * @export
 */
exports.CreateOrUpdateBankTransactionRequestBodyDtoTypeEnum = {
    Debit: 'DEBIT',
    Credit: 'CREDIT'
};
/**
 * @export
 */
exports.CreateOrUpdateBankTransactionRequestBodyDtoStatusEnum = {
    Pending: 'PENDING',
    Posted: 'POSTED'
};
/**
 ...
 */
function instanceOfCreateOrUpdateBankTransactionRequestBodyDto(value) {
...
function CreateOrUpdateBankTransactionRequestBodyDtoFromJSON(json) {
    return CreateOrUpdateBankTransactionRequestBodyDtoFromJSONTyped(json, false);
}
function CreateOrUpdateBankTransactionRequestBodyDtoFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function CreateOrUpdateBankTransactionRequestBodyDtoToJSONTyped(value, ignoreDiscriminator) {
