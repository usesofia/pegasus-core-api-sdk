...
exports.CreateInboxRecordRequestBodyDtoBestSuggestedActionInboxRawCreateFinancialRecordRequestDirectionEnum = void 0;
exports.instanceOfCreateInboxRecordRequestBodyDtoBestSuggestedActionInboxRawCreateFinancialRecordRequest = instanceOfCreateInboxRecordRequestBodyDtoBestSuggestedActionInboxRawCreateFinancialRecordRequest;
exports.CreateInboxRecordRequestBodyDtoBestSuggestedActionInboxRawCreateFinancialRecordRequestFromJSON = CreateInboxRecordRequestBodyDtoBestSuggestedActionInboxRawCreateFinancialRecordRequestFromJSON;
exports.CreateInboxRecordRequestBodyDtoBestSuggestedActionInboxRawCreateFinancialRecordRequestFromJSONTyped = CreateInboxRecordRequestBodyDtoBestSuggestedActionInboxRawCreateFinancialRecordRequestFromJSONTyped;
exports.CreateInboxRecordRequestBodyDtoBestSuggestedActionInboxRawCreateFinancialRecordRequestToJSON = CreateInboxRecordRequestBodyDtoBestSuggestedActionInboxRawCreateFinancialRecordRequestToJSON;
exports.CreateInboxRecordRequestBodyDtoBestSuggestedActionInboxRawCreateFinancialRecordRequestToJSONTyped = CreateInboxRecordRequestBodyDtoBestSuggestedActionInboxRawCreateFinancialRecordRequestToJSONTyped;
 ...
 * @export
 */
exports.CreateInboxRecordRequestBodyDtoBestSuggestedActionInboxRawCreateFinancialRecordRequestDirectionEnum = {
    Income: 'INCOME',
    Outcome: 'OUTCOME'
};
/**
 ...
 */
function instanceOfCreateInboxRecordRequestBodyDtoBestSuggestedActionInboxRawCreateFinancialRecordRequest(value) {
...
function CreateInboxRecordRequestBodyDtoBestSuggestedActionInboxRawCreateFinancialRecordRequestFromJSON(json) {
    return CreateInboxRecordRequestBodyDtoBestSuggestedActionInboxRawCreateFinancialRecordRequestFromJSONTyped(json, false);
}
function CreateInboxRecordRequestBodyDtoBestSuggestedActionInboxRawCreateFinancialRecordRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function CreateInboxRecordRequestBodyDtoBestSuggestedActionInboxRawCreateFinancialRecordRequestToJSON(json) {
    return CreateInboxRecordRequestBodyDtoBestSuggestedActionInboxRawCreateFinancialRecordRequestToJSONTyped(json, false);
}
function CreateInboxRecordRequestBodyDtoBestSuggestedActionInboxRawCreateFinancialRecordRequestToJSONTyped(value, ignoreDiscriminator) {
