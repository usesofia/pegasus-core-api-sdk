...
exports.CreateRecurringFinancialRecordRequestBodyDtoChannelEnum = exports.CreateRecurringFinancialRecordRequestBodyDtoFrequencyEnum = exports.CreateRecurringFinancialRecordRequestBodyDtoDirectionEnum = void 0;
exports.instanceOfCreateRecurringFinancialRecordRequestBodyDto = instanceOfCreateRecurringFinancialRecordRequestBodyDto;
exports.CreateRecurringFinancialRecordRequestBodyDtoFromJSON = CreateRecurringFinancialRecordRequestBodyDtoFromJSON;
exports.CreateRecurringFinancialRecordRequestBodyDtoFromJSONTyped = CreateRecurringFinancialRecordRequestBodyDtoFromJSONTyped;
exports.CreateRecurringFinancialRecordRequestBodyDtoToJSON = CreateRecurringFinancialRecordRequestBodyDtoToJSON;
exports.CreateRecurringFinancialRecordRequestBodyDtoToJSONTyped = CreateRecurringFinancialRecordRequestBodyDtoToJSONTyped;
 ...
 * @export
 */
exports.CreateRecurringFinancialRecordRequestBodyDtoDirectionEnum = {
    In: 'IN',
    Out: 'OUT'
};
/**
 * @export
 */
exports.CreateRecurringFinancialRecordRequestBodyDtoFrequencyEnum = {
    Weekly: 'WEEKLY',
    Monthly: 'MONTHLY',
    Yearly: 'YEARLY'
};
 ...
 */
function instanceOfCreateRecurringFinancialRecordRequestBodyDto(value) {
...
function CreateRecurringFinancialRecordRequestBodyDtoFromJSON(json) {
    return CreateRecurringFinancialRecordRequestBodyDtoFromJSONTyped(json, false);
}
function CreateRecurringFinancialRecordRequestBodyDtoFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function CreateRecurringFinancialRecordRequestBodyDtoToJSON(json) {
    return CreateRecurringFinancialRecordRequestBodyDtoToJSONTyped(json, false);
}
function CreateRecurringFinancialRecordRequestBodyDtoToJSONTyped(value, ignoreDiscriminator) {
