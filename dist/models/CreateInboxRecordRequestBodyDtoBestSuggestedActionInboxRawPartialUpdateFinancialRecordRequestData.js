...
exports.CreateInboxRecordRequestBodyDtoBestSuggestedActionInboxRawPartialUpdateFinancialRecordRequestDataDirectionEnum = void 0;
exports.instanceOfCreateInboxRecordRequestBodyDtoBestSuggestedActionInboxRawPartialUpdateFinancialRecordRequestData = instanceOfCreateInboxRecordRequestBodyDtoBestSuggestedActionInboxRawPartialUpdateFinancialRecordRequestData;
exports.CreateInboxRecordRequestBodyDtoBestSuggestedActionInboxRawPartialUpdateFinancialRecordRequestDataFromJSON = CreateInboxRecordRequestBodyDtoBestSuggestedActionInboxRawPartialUpdateFinancialRecordRequestDataFromJSON;
exports.CreateInboxRecordRequestBodyDtoBestSuggestedActionInboxRawPartialUpdateFinancialRecordRequestDataFromJSONTyped = CreateInboxRecordRequestBodyDtoBestSuggestedActionInboxRawPartialUpdateFinancialRecordRequestDataFromJSONTyped;
exports.CreateInboxRecordRequestBodyDtoBestSuggestedActionInboxRawPartialUpdateFinancialRecordRequestDataToJSON = CreateInboxRecordRequestBodyDtoBestSuggestedActionInboxRawPartialUpdateFinancialRecordRequestDataToJSON;
exports.CreateInboxRecordRequestBodyDtoBestSuggestedActionInboxRawPartialUpdateFinancialRecordRequestDataToJSONTyped = CreateInboxRecordRequestBodyDtoBestSuggestedActionInboxRawPartialUpdateFinancialRecordRequestDataToJSONTyped;
 ...
 * @export
 */
exports.CreateInboxRecordRequestBodyDtoBestSuggestedActionInboxRawPartialUpdateFinancialRecordRequestDataDirectionEnum = {
    Income: 'INCOME',
    Outcome: 'OUTCOME'
};
/**
 ...
 */
function instanceOfCreateInboxRecordRequestBodyDtoBestSuggestedActionInboxRawPartialUpdateFinancialRecordRequestData(value) {
    return true;
}
function CreateInboxRecordRequestBodyDtoBestSuggestedActionInboxRawPartialUpdateFinancialRecordRequestDataFromJSON(json) {
...
function CreateInboxRecordRequestBodyDtoBestSuggestedActionInboxRawPartialUpdateFinancialRecordRequestDataFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function CreateInboxRecordRequestBodyDtoBestSuggestedActionInboxRawPartialUpdateFinancialRecordRequestDataToJSON(json) {
...
function CreateInboxRecordRequestBodyDtoBestSuggestedActionInboxRawPartialUpdateFinancialRecordRequestDataToJSONTyped(value, ignoreDiscriminator) {
