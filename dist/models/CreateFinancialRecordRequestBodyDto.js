...
exports.CreateFinancialRecordRequestBodyDtoChannelEnum = exports.CreateFinancialRecordRequestBodyDtoDirectionEnum = void 0;
exports.instanceOfCreateFinancialRecordRequestBodyDto = instanceOfCreateFinancialRecordRequestBodyDto;
exports.CreateFinancialRecordRequestBodyDtoFromJSON = CreateFinancialRecordRequestBodyDtoFromJSON;
exports.CreateFinancialRecordRequestBodyDtoFromJSONTyped = CreateFinancialRecordRequestBodyDtoFromJSONTyped;
 ...
 */
function instanceOfCreateFinancialRecordRequestBodyDto(value) {
...
function CreateFinancialRecordRequestBodyDtoFromJSON(json) {
    return CreateFinancialRecordRequestBodyDtoFromJSONTyped(json, false);
}
function CreateFinancialRecordRequestBodyDtoFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function CreateFinancialRecordRequestBodyDtoToJSON(json) {
    return CreateFinancialRecordRequestBodyDtoToJSONTyped(json, false);
}
function CreateFinancialRecordRequestBodyDtoToJSONTyped(value, ignoreDiscriminator) {
