...
exports.CreatedFinancialRecordRadarItemResultEntityRadarItemAutoExecuteCreatedFinancialRecordDirectionEnum = void 0;
exports.instanceOfCreatedFinancialRecordRadarItemResultEntityRadarItemAutoExecuteCreatedFinancialRecord = instanceOfCreatedFinancialRecordRadarItemResultEntityRadarItemAutoExecuteCreatedFinancialRecord;
exports.CreatedFinancialRecordRadarItemResultEntityRadarItemAutoExecuteCreatedFinancialRecordFromJSON = CreatedFinancialRecordRadarItemResultEntityRadarItemAutoExecuteCreatedFinancialRecordFromJSON;
exports.CreatedFinancialRecordRadarItemResultEntityRadarItemAutoExecuteCreatedFinancialRecordFromJSONTyped = CreatedFinancialRecordRadarItemResultEntityRadarItemAutoExecuteCreatedFinancialRecordFromJSONTyped;
exports.CreatedFinancialRecordRadarItemResultEntityRadarItemAutoExecuteCreatedFinancialRecordToJSON = CreatedFinancialRecordRadarItemResultEntityRadarItemAutoExecuteCreatedFinancialRecordToJSON;
exports.CreatedFinancialRecordRadarItemResultEntityRadarItemAutoExecuteCreatedFinancialRecordToJSONTyped = CreatedFinancialRecordRadarItemResultEntityRadarItemAutoExecuteCreatedFinancialRecordToJSONTyped;
 ...
 * @export
 */
exports.CreatedFinancialRecordRadarItemResultEntityRadarItemAutoExecuteCreatedFinancialRecordDirectionEnum = {
    In: 'IN',
    Out: 'OUT'
};
/**
 ...
 */
function instanceOfCreatedFinancialRecordRadarItemResultEntityRadarItemAutoExecuteCreatedFinancialRecord(value) {
...
function CreatedFinancialRecordRadarItemResultEntityRadarItemAutoExecuteCreatedFinancialRecordFromJSON(json) {
    return CreatedFinancialRecordRadarItemResultEntityRadarItemAutoExecuteCreatedFinancialRecordFromJSONTyped(json, false);
}
function CreatedFinancialRecordRadarItemResultEntityRadarItemAutoExecuteCreatedFinancialRecordFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function CreatedFinancialRecordRadarItemResultEntityRadarItemAutoExecuteCreatedFinancialRecordToJSON(json) {
    return CreatedFinancialRecordRadarItemResultEntityRadarItemAutoExecuteCreatedFinancialRecordToJSONTyped(json, false);
}
function CreatedFinancialRecordRadarItemResultEntityRadarItemAutoExecuteCreatedFinancialRecordToJSONTyped(value, ignoreDiscriminator) {
