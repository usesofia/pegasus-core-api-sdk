...
exports.FinancialRecordGroupDtoPopulatedFinancialRecordsInnerDirectionEnum = void 0;
exports.instanceOfFinancialRecordGroupDtoPopulatedFinancialRecordsInner = instanceOfFinancialRecordGroupDtoPopulatedFinancialRecordsInner;
exports.FinancialRecordGroupDtoPopulatedFinancialRecordsInnerFromJSON = FinancialRecordGroupDtoPopulatedFinancialRecordsInnerFromJSON;
exports.FinancialRecordGroupDtoPopulatedFinancialRecordsInnerFromJSONTyped = FinancialRecordGroupDtoPopulatedFinancialRecordsInnerFromJSONTyped;
exports.FinancialRecordGroupDtoPopulatedFinancialRecordsInnerToJSON = FinancialRecordGroupDtoPopulatedFinancialRecordsInnerToJSON;
exports.FinancialRecordGroupDtoPopulatedFinancialRecordsInnerToJSONTyped = FinancialRecordGroupDtoPopulatedFinancialRecordsInnerToJSONTyped;
 ...
 * @export
 */
exports.FinancialRecordGroupDtoPopulatedFinancialRecordsInnerDirectionEnum = {
    In: 'IN',
    Out: 'OUT'
};
/**
 ...
 */
function instanceOfFinancialRecordGroupDtoPopulatedFinancialRecordsInner(value) {
...
function FinancialRecordGroupDtoPopulatedFinancialRecordsInnerFromJSON(json) {
    return FinancialRecordGroupDtoPopulatedFinancialRecordsInnerFromJSONTyped(json, false);
}
function FinancialRecordGroupDtoPopulatedFinancialRecordsInnerFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function FinancialRecordGroupDtoPopulatedFinancialRecordsInnerToJSON(json) {
    return FinancialRecordGroupDtoPopulatedFinancialRecordsInnerToJSONTyped(json, false);
}
function FinancialRecordGroupDtoPopulatedFinancialRecordsInnerToJSONTyped(value, ignoreDiscriminator) {
