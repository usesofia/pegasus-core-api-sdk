...
exports.BankTransactionEntityStatusEnum = exports.BankTransactionEntityTypeEnum = exports.BankTransactionEntityProviderEnum = void 0;
exports.instanceOfBankTransactionEntity = instanceOfBankTransactionEntity;
exports.BankTransactionEntityFromJSON = BankTransactionEntityFromJSON;
 ...
 */
function instanceOfBankTransactionEntity(value) {
...
function BankTransactionEntityFromJSON(json) {
    return BankTransactionEntityFromJSONTyped(json, false);
}
function BankTransactionEntityFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function BankTransactionEntityToJSONTyped(value, ignoreDiscriminator) {
