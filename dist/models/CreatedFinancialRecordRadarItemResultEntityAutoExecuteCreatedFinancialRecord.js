...
exports.CreatedFinancialRecordRadarItemResultEntityAutoExecuteCreatedFinancialRecordDirectionEnum = void 0;
exports.instanceOfCreatedFinancialRecordRadarItemResultEntityAutoExecuteCreatedFinancialRecord = instanceOfCreatedFinancialRecordRadarItemResultEntityAutoExecuteCreatedFinancialRecord;
exports.CreatedFinancialRecordRadarItemResultEntityAutoExecuteCreatedFinancialRecordFromJSON = CreatedFinancialRecordRadarItemResultEntityAutoExecuteCreatedFinancialRecordFromJSON;
exports.CreatedFinancialRecordRadarItemResultEntityAutoExecuteCreatedFinancialRecordFromJSONTyped = CreatedFinancialRecordRadarItemResultEntityAutoExecuteCreatedFinancialRecordFromJSONTyped;
exports.CreatedFinancialRecordRadarItemResultEntityAutoExecuteCreatedFinancialRecordToJSON = CreatedFinancialRecordRadarItemResultEntityAutoExecuteCreatedFinancialRecordToJSON;
exports.CreatedFinancialRecordRadarItemResultEntityAutoExecuteCreatedFinancialRecordToJSONTyped = CreatedFinancialRecordRadarItemResultEntityAutoExecuteCreatedFinancialRecordToJSONTyped;
 ...
 * @export
 */
exports.CreatedFinancialRecordRadarItemResultEntityAutoExecuteCreatedFinancialRecordDirectionEnum = {
    In: 'IN',
    Out: 'OUT'
};
/**
 ...
 */
function instanceOfCreatedFinancialRecordRadarItemResultEntityAutoExecuteCreatedFinancialRecord(value) {
...
function CreatedFinancialRecordRadarItemResultEntityAutoExecuteCreatedFinancialRecordFromJSON(json) {
    return CreatedFinancialRecordRadarItemResultEntityAutoExecuteCreatedFinancialRecordFromJSONTyped(json, false);
}
function CreatedFinancialRecordRadarItemResultEntityAutoExecuteCreatedFinancialRecordFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function CreatedFinancialRecordRadarItemResultEntityAutoExecuteCreatedFinancialRecordToJSON(json) {
    return CreatedFinancialRecordRadarItemResultEntityAutoExecuteCreatedFinancialRecordToJSONTyped(json, false);
}
function CreatedFinancialRecordRadarItemResultEntityAutoExecuteCreatedFinancialRecordToJSONTyped(value, ignoreDiscriminator) {
