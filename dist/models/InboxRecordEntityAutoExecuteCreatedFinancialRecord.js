...
exports.InboxRecordEntityAutoExecuteCreatedFinancialRecordDirectionEnum = void 0;
exports.instanceOfInboxRecordEntityAutoExecuteCreatedFinancialRecord = instanceOfInboxRecordEntityAutoExecuteCreatedFinancialRecord;
exports.InboxRecordEntityAutoExecuteCreatedFinancialRecordFromJSON = InboxRecordEntityAutoExecuteCreatedFinancialRecordFromJSON;
exports.InboxRecordEntityAutoExecuteCreatedFinancialRecordFromJSONTyped = InboxRecordEntityAutoExecuteCreatedFinancialRecordFromJSONTyped;
exports.InboxRecordEntityAutoExecuteCreatedFinancialRecordToJSON = InboxRecordEntityAutoExecuteCreatedFinancialRecordToJSON;
exports.InboxRecordEntityAutoExecuteCreatedFinancialRecordToJSONTyped = InboxRecordEntityAutoExecuteCreatedFinancialRecordToJSONTyped;
 ...
 * @export
 */
exports.InboxRecordEntityAutoExecuteCreatedFinancialRecordDirectionEnum = {
    Income: 'INCOME',
    Outcome: 'OUTCOME'
};
/**
 ...
 */
function instanceOfInboxRecordEntityAutoExecuteCreatedFinancialRecord(value) {
...
function InboxRecordEntityAutoExecuteCreatedFinancialRecordFromJSON(json) {
    return InboxRecordEntityAutoExecuteCreatedFinancialRecordFromJSONTyped(json, false);
}
function InboxRecordEntityAutoExecuteCreatedFinancialRecordFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function InboxRecordEntityAutoExecuteCreatedFinancialRecordToJSON(json) {
    return InboxRecordEntityAutoExecuteCreatedFinancialRecordToJSONTyped(json, false);
}
function InboxRecordEntityAutoExecuteCreatedFinancialRecordToJSONTyped(value, ignoreDiscriminator) {
