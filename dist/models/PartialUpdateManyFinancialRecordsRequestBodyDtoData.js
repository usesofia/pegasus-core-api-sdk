...
exports.PartialUpdateManyFinancialRecordsRequestBodyDtoDataDirectionEnum = void 0;
exports.instanceOfPartialUpdateManyFinancialRecordsRequestBodyDtoData = instanceOfPartialUpdateManyFinancialRecordsRequestBodyDtoData;
exports.PartialUpdateManyFinancialRecordsRequestBodyDtoDataFromJSON = PartialUpdateManyFinancialRecordsRequestBodyDtoDataFromJSON;
exports.PartialUpdateManyFinancialRecordsRequestBodyDtoDataFromJSONTyped = PartialUpdateManyFinancialRecordsRequestBodyDtoDataFromJSONTyped;
exports.PartialUpdateManyFinancialRecordsRequestBodyDtoDataToJSON = PartialUpdateManyFinancialRecordsRequestBodyDtoDataToJSON;
exports.PartialUpdateManyFinancialRecordsRequestBodyDtoDataToJSONTyped = PartialUpdateManyFinancialRecordsRequestBodyDtoDataToJSONTyped;
 ...
 * @export
 */
exports.PartialUpdateManyFinancialRecordsRequestBodyDtoDataDirectionEnum = {
    In: 'IN',
    Out: 'OUT'
};
/**
 ...
 */
function instanceOfPartialUpdateManyFinancialRecordsRequestBodyDtoData(value) {
    return true;
}
function PartialUpdateManyFinancialRecordsRequestBodyDtoDataFromJSON(json) {
    return PartialUpdateManyFinancialRecordsRequestBodyDtoDataFromJSONTyped(json, false);
}
function PartialUpdateManyFinancialRecordsRequestBodyDtoDataFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function PartialUpdateManyFinancialRecordsRequestBodyDtoDataToJSON(json) {
    return PartialUpdateManyFinancialRecordsRequestBodyDtoDataToJSONTyped(json, false);
}
function PartialUpdateManyFinancialRecordsRequestBodyDtoDataToJSONTyped(value, ignoreDiscriminator) {
