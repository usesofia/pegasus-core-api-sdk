...
exports.InstallmentFinancialRecordsPageDtoItemsInnerFrequencyEnum = exports.InstallmentFinancialRecordsPageDtoItemsInnerDirectionEnum = void 0;
exports.instanceOfInstallmentFinancialRecordsPageDtoItemsInner = instanceOfInstallmentFinancialRecordsPageDtoItemsInner;
exports.InstallmentFinancialRecordsPageDtoItemsInnerFromJSON = InstallmentFinancialRecordsPageDtoItemsInnerFromJSON;
exports.InstallmentFinancialRecordsPageDtoItemsInnerFromJSONTyped = InstallmentFinancialRecordsPageDtoItemsInnerFromJSONTyped;
exports.InstallmentFinancialRecordsPageDtoItemsInnerToJSON = InstallmentFinancialRecordsPageDtoItemsInnerToJSON;
exports.InstallmentFinancialRecordsPageDtoItemsInnerToJSONTyped = InstallmentFinancialRecordsPageDtoItemsInnerToJSONTyped;
 ...
 * @export
 */
exports.InstallmentFinancialRecordsPageDtoItemsInnerFrequencyEnum = {
    Monthly: 'MONTHLY',
    Weekly: 'WEEKLY',
    Yearly: 'YEARLY'
};
 ...
 */
function instanceOfInstallmentFinancialRecordsPageDtoItemsInner(value) {
...
function InstallmentFinancialRecordsPageDtoItemsInnerFromJSON(json) {
    return InstallmentFinancialRecordsPageDtoItemsInnerFromJSONTyped(json, false);
}
function InstallmentFinancialRecordsPageDtoItemsInnerFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function InstallmentFinancialRecordsPageDtoItemsInnerToJSON(json) {
    return InstallmentFinancialRecordsPageDtoItemsInnerToJSONTyped(json, false);
}
function InstallmentFinancialRecordsPageDtoItemsInnerToJSONTyped(value, ignoreDiscriminator) {
