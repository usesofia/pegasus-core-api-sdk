...
exports.FinancialRecordRadarItemEntityAutoExecutePartialUpdatedFinancialRecordDirectionEnum = void 0;
exports.instanceOfFinancialRecordRadarItemEntityAutoExecutePartialUpdatedFinancialRecord = instanceOfFinancialRecordRadarItemEntityAutoExecutePartialUpdatedFinancialRecord;
exports.FinancialRecordRadarItemEntityAutoExecutePartialUpdatedFinancialRecordFromJSON = FinancialRecordRadarItemEntityAutoExecutePartialUpdatedFinancialRecordFromJSON;
exports.FinancialRecordRadarItemEntityAutoExecutePartialUpdatedFinancialRecordFromJSONTyped = FinancialRecordRadarItemEntityAutoExecutePartialUpdatedFinancialRecordFromJSONTyped;
exports.FinancialRecordRadarItemEntityAutoExecutePartialUpdatedFinancialRecordToJSON = FinancialRecordRadarItemEntityAutoExecutePartialUpdatedFinancialRecordToJSON;
exports.FinancialRecordRadarItemEntityAutoExecutePartialUpdatedFinancialRecordToJSONTyped = FinancialRecordRadarItemEntityAutoExecutePartialUpdatedFinancialRecordToJSONTyped;
 ...
 * @export
 */
exports.FinancialRecordRadarItemEntityAutoExecutePartialUpdatedFinancialRecordDirectionEnum = {
    In: 'IN',
    Out: 'OUT'
};
/**
 ...
 */
function instanceOfFinancialRecordRadarItemEntityAutoExecutePartialUpdatedFinancialRecord(value) {
...
function FinancialRecordRadarItemEntityAutoExecutePartialUpdatedFinancialRecordFromJSON(json) {
    return FinancialRecordRadarItemEntityAutoExecutePartialUpdatedFinancialRecordFromJSONTyped(json, false);
}
function FinancialRecordRadarItemEntityAutoExecutePartialUpdatedFinancialRecordFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function FinancialRecordRadarItemEntityAutoExecutePartialUpdatedFinancialRecordToJSON(json) {
    return FinancialRecordRadarItemEntityAutoExecutePartialUpdatedFinancialRecordToJSONTyped(json, false);
}
function FinancialRecordRadarItemEntityAutoExecutePartialUpdatedFinancialRecordToJSONTyped(value, ignoreDiscriminator) {
