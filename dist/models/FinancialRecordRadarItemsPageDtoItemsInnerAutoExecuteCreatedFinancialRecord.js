...
exports.FinancialRecordRadarItemsPageDtoItemsInnerAutoExecuteCreatedFinancialRecordDirectionEnum = void 0;
exports.instanceOfFinancialRecordRadarItemsPageDtoItemsInnerAutoExecuteCreatedFinancialRecord = instanceOfFinancialRecordRadarItemsPageDtoItemsInnerAutoExecuteCreatedFinancialRecord;
exports.FinancialRecordRadarItemsPageDtoItemsInnerAutoExecuteCreatedFinancialRecordFromJSON = FinancialRecordRadarItemsPageDtoItemsInnerAutoExecuteCreatedFinancialRecordFromJSON;
exports.FinancialRecordRadarItemsPageDtoItemsInnerAutoExecuteCreatedFinancialRecordFromJSONTyped = FinancialRecordRadarItemsPageDtoItemsInnerAutoExecuteCreatedFinancialRecordFromJSONTyped;
exports.FinancialRecordRadarItemsPageDtoItemsInnerAutoExecuteCreatedFinancialRecordToJSON = FinancialRecordRadarItemsPageDtoItemsInnerAutoExecuteCreatedFinancialRecordToJSON;
exports.FinancialRecordRadarItemsPageDtoItemsInnerAutoExecuteCreatedFinancialRecordToJSONTyped = FinancialRecordRadarItemsPageDtoItemsInnerAutoExecuteCreatedFinancialRecordToJSONTyped;
 ...
 * @export
 */
exports.FinancialRecordRadarItemsPageDtoItemsInnerAutoExecuteCreatedFinancialRecordDirectionEnum = {
    In: 'IN',
    Out: 'OUT'
};
/**
 ...
 */
function instanceOfFinancialRecordRadarItemsPageDtoItemsInnerAutoExecuteCreatedFinancialRecord(value) {
...
function FinancialRecordRadarItemsPageDtoItemsInnerAutoExecuteCreatedFinancialRecordFromJSON(json) {
    return FinancialRecordRadarItemsPageDtoItemsInnerAutoExecuteCreatedFinancialRecordFromJSONTyped(json, false);
}
function FinancialRecordRadarItemsPageDtoItemsInnerAutoExecuteCreatedFinancialRecordFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function FinancialRecordRadarItemsPageDtoItemsInnerAutoExecuteCreatedFinancialRecordToJSON(json) {
    return FinancialRecordRadarItemsPageDtoItemsInnerAutoExecuteCreatedFinancialRecordToJSONTyped(json, false);
}
function FinancialRecordRadarItemsPageDtoItemsInnerAutoExecuteCreatedFinancialRecordToJSONTyped(value, ignoreDiscriminator) {
