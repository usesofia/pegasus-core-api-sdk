...
exports.InboxRecordEntityAutoExecutePartialUpdatedFinancialRecordDirectionEnum = void 0;
exports.instanceOfInboxRecordEntityAutoExecutePartialUpdatedFinancialRecord = instanceOfInboxRecordEntityAutoExecutePartialUpdatedFinancialRecord;
exports.InboxRecordEntityAutoExecutePartialUpdatedFinancialRecordFromJSON = InboxRecordEntityAutoExecutePartialUpdatedFinancialRecordFromJSON;
exports.InboxRecordEntityAutoExecutePartialUpdatedFinancialRecordFromJSONTyped = InboxRecordEntityAutoExecutePartialUpdatedFinancialRecordFromJSONTyped;
exports.InboxRecordEntityAutoExecutePartialUpdatedFinancialRecordToJSON = InboxRecordEntityAutoExecutePartialUpdatedFinancialRecordToJSON;
exports.InboxRecordEntityAutoExecutePartialUpdatedFinancialRecordToJSONTyped = InboxRecordEntityAutoExecutePartialUpdatedFinancialRecordToJSONTyped;
 ...
 * @export
 */
exports.InboxRecordEntityAutoExecutePartialUpdatedFinancialRecordDirectionEnum = {
    Income: 'INCOME',
    Outcome: 'OUTCOME'
};
/**
 ...
 */
function instanceOfInboxRecordEntityAutoExecutePartialUpdatedFinancialRecord(value) {
...
function InboxRecordEntityAutoExecutePartialUpdatedFinancialRecordFromJSON(json) {
    return InboxRecordEntityAutoExecutePartialUpdatedFinancialRecordFromJSONTyped(json, false);
}
function InboxRecordEntityAutoExecutePartialUpdatedFinancialRecordFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function InboxRecordEntityAutoExecutePartialUpdatedFinancialRecordToJSON(json) {
    return InboxRecordEntityAutoExecutePartialUpdatedFinancialRecordToJSONTyped(json, false);
}
function InboxRecordEntityAutoExecutePartialUpdatedFinancialRecordToJSONTyped(value, ignoreDiscriminator) {
