...
exports.CreatedFinancialRecordRadarItemResultEntityAutoExecutePartialUpdatedFinancialRecordDirectionEnum = void 0;
exports.instanceOfCreatedFinancialRecordRadarItemResultEntityAutoExecutePartialUpdatedFinancialRecord = instanceOfCreatedFinancialRecordRadarItemResultEntityAutoExecutePartialUpdatedFinancialRecord;
exports.CreatedFinancialRecordRadarItemResultEntityAutoExecutePartialUpdatedFinancialRecordFromJSON = CreatedFinancialRecordRadarItemResultEntityAutoExecutePartialUpdatedFinancialRecordFromJSON;
exports.CreatedFinancialRecordRadarItemResultEntityAutoExecutePartialUpdatedFinancialRecordFromJSONTyped = CreatedFinancialRecordRadarItemResultEntityAutoExecutePartialUpdatedFinancialRecordFromJSONTyped;
exports.CreatedFinancialRecordRadarItemResultEntityAutoExecutePartialUpdatedFinancialRecordToJSON = CreatedFinancialRecordRadarItemResultEntityAutoExecutePartialUpdatedFinancialRecordToJSON;
exports.CreatedFinancialRecordRadarItemResultEntityAutoExecutePartialUpdatedFinancialRecordToJSONTyped = CreatedFinancialRecordRadarItemResultEntityAutoExecutePartialUpdatedFinancialRecordToJSONTyped;
 ...
 * @export
 */
exports.CreatedFinancialRecordRadarItemResultEntityAutoExecutePartialUpdatedFinancialRecordDirectionEnum = {
    In: 'IN',
    Out: 'OUT'
};
/**
 ...
 */
function instanceOfCreatedFinancialRecordRadarItemResultEntityAutoExecutePartialUpdatedFinancialRecord(value) {
...
function CreatedFinancialRecordRadarItemResultEntityAutoExecutePartialUpdatedFinancialRecordFromJSON(json) {
    return CreatedFinancialRecordRadarItemResultEntityAutoExecutePartialUpdatedFinancialRecordFromJSONTyped(json, false);
}
function CreatedFinancialRecordRadarItemResultEntityAutoExecutePartialUpdatedFinancialRecordFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function CreatedFinancialRecordRadarItemResultEntityAutoExecutePartialUpdatedFinancialRecordToJSON(json) {
    return CreatedFinancialRecordRadarItemResultEntityAutoExecutePartialUpdatedFinancialRecordToJSONTyped(json, false);
}
function CreatedFinancialRecordRadarItemResultEntityAutoExecutePartialUpdatedFinancialRecordToJSONTyped(value, ignoreDiscriminator) {
