...
exports.FinancialRecordRadarItemEntityAutoExecuteCreatedFinancialRecordDirectionEnum = void 0;
exports.instanceOfFinancialRecordRadarItemEntityAutoExecuteCreatedFinancialRecord = instanceOfFinancialRecordRadarItemEntityAutoExecuteCreatedFinancialRecord;
exports.FinancialRecordRadarItemEntityAutoExecuteCreatedFinancialRecordFromJSON = FinancialRecordRadarItemEntityAutoExecuteCreatedFinancialRecordFromJSON;
exports.FinancialRecordRadarItemEntityAutoExecuteCreatedFinancialRecordFromJSONTyped = FinancialRecordRadarItemEntityAutoExecuteCreatedFinancialRecordFromJSONTyped;
exports.FinancialRecordRadarItemEntityAutoExecuteCreatedFinancialRecordToJSON = FinancialRecordRadarItemEntityAutoExecuteCreatedFinancialRecordToJSON;
exports.FinancialRecordRadarItemEntityAutoExecuteCreatedFinancialRecordToJSONTyped = FinancialRecordRadarItemEntityAutoExecuteCreatedFinancialRecordToJSONTyped;
 ...
 * @export
 */
exports.FinancialRecordRadarItemEntityAutoExecuteCreatedFinancialRecordDirectionEnum = {
    In: 'IN',
    Out: 'OUT'
};
/**
 ...
 */
function instanceOfFinancialRecordRadarItemEntityAutoExecuteCreatedFinancialRecord(value) {
...
function FinancialRecordRadarItemEntityAutoExecuteCreatedFinancialRecordFromJSON(json) {
    return FinancialRecordRadarItemEntityAutoExecuteCreatedFinancialRecordFromJSONTyped(json, false);
}
function FinancialRecordRadarItemEntityAutoExecuteCreatedFinancialRecordFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function FinancialRecordRadarItemEntityAutoExecuteCreatedFinancialRecordToJSONTyped(value, ignoreDiscriminator) {
