...
exports.instanceOfNormalizedSubcategoriesPageEntityItemsInner = instanceOfNormalizedSubcategoriesPageEntityItemsInner;
exports.NormalizedSubcategoriesPageEntityItemsInnerFromJSON = NormalizedSubcategoriesPageEntityItemsInnerFromJSON;
 ...
 */
function instanceOfNormalizedSubcategoriesPageEntityItemsInner(value) {
...
function NormalizedSubcategoriesPageEntityItemsInnerFromJSON(json) {
    return NormalizedSubcategoriesPageEntityItemsInnerFromJSONTyped(json, false);
}
function NormalizedSubcategoriesPageEntityItemsInnerFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function NormalizedSubcategoriesPageEntityItemsInnerToJSON(json) {
    return NormalizedSubcategoriesPageEntityItemsInnerToJSONTyped(json, false);
}
function NormalizedSubcategoriesPageEntityItemsInnerToJSONTyped(value, ignoreDiscriminator) {
