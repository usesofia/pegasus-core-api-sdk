...
exports.CreatedFinancialRecordRadarItemResultEntityAutoExecuteLinkedFinancialRecordDirectionEnum = void 0;
exports.instanceOfCreatedFinancialRecordRadarItemResultEntityAutoExecuteLinkedFinancialRecord = instanceOfCreatedFinancialRecordRadarItemResultEntityAutoExecuteLinkedFinancialRecord;
exports.CreatedFinancialRecordRadarItemResultEntityAutoExecuteLinkedFinancialRecordFromJSON = CreatedFinancialRecordRadarItemResultEntityAutoExecuteLinkedFinancialRecordFromJSON;
exports.CreatedFinancialRecordRadarItemResultEntityAutoExecuteLinkedFinancialRecordFromJSONTyped = CreatedFinancialRecordRadarItemResultEntityAutoExecuteLinkedFinancialRecordFromJSONTyped;
exports.CreatedFinancialRecordRadarItemResultEntityAutoExecuteLinkedFinancialRecordToJSON = CreatedFinancialRecordRadarItemResultEntityAutoExecuteLinkedFinancialRecordToJSON;
exports.CreatedFinancialRecordRadarItemResultEntityAutoExecuteLinkedFinancialRecordToJSONTyped = CreatedFinancialRecordRadarItemResultEntityAutoExecuteLinkedFinancialRecordToJSONTyped;
 ...
 * @export
 */
exports.CreatedFinancialRecordRadarItemResultEntityAutoExecuteLinkedFinancialRecordDirectionEnum = {
    In: 'IN',
    Out: 'OUT'
};
/**
 ...
 */
function instanceOfCreatedFinancialRecordRadarItemResultEntityAutoExecuteLinkedFinancialRecord(value) {
...
function CreatedFinancialRecordRadarItemResultEntityAutoExecuteLinkedFinancialRecordFromJSON(json) {
    return CreatedFinancialRecordRadarItemResultEntityAutoExecuteLinkedFinancialRecordFromJSONTyped(json, false);
}
function CreatedFinancialRecordRadarItemResultEntityAutoExecuteLinkedFinancialRecordFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function CreatedFinancialRecordRadarItemResultEntityAutoExecuteLinkedFinancialRecordToJSON(json) {
    return CreatedFinancialRecordRadarItemResultEntityAutoExecuteLinkedFinancialRecordToJSONTyped(json, false);
}
function CreatedFinancialRecordRadarItemResultEntityAutoExecuteLinkedFinancialRecordToJSONTyped(value, ignoreDiscriminator) {
