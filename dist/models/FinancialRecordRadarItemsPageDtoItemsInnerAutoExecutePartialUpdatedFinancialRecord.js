...
exports.FinancialRecordRadarItemsPageDtoItemsInnerAutoExecutePartialUpdatedFinancialRecordDirectionEnum = void 0;
exports.instanceOfFinancialRecordRadarItemsPageDtoItemsInnerAutoExecutePartialUpdatedFinancialRecord = instanceOfFinancialRecordRadarItemsPageDtoItemsInnerAutoExecutePartialUpdatedFinancialRecord;
exports.FinancialRecordRadarItemsPageDtoItemsInnerAutoExecutePartialUpdatedFinancialRecordFromJSON = FinancialRecordRadarItemsPageDtoItemsInnerAutoExecutePartialUpdatedFinancialRecordFromJSON;
exports.FinancialRecordRadarItemsPageDtoItemsInnerAutoExecutePartialUpdatedFinancialRecordFromJSONTyped = FinancialRecordRadarItemsPageDtoItemsInnerAutoExecutePartialUpdatedFinancialRecordFromJSONTyped;
exports.FinancialRecordRadarItemsPageDtoItemsInnerAutoExecutePartialUpdatedFinancialRecordToJSON = FinancialRecordRadarItemsPageDtoItemsInnerAutoExecutePartialUpdatedFinancialRecordToJSON;
exports.FinancialRecordRadarItemsPageDtoItemsInnerAutoExecutePartialUpdatedFinancialRecordToJSONTyped = FinancialRecordRadarItemsPageDtoItemsInnerAutoExecutePartialUpdatedFinancialRecordToJSONTyped;
 ...
 * @export
 */
exports.FinancialRecordRadarItemsPageDtoItemsInnerAutoExecutePartialUpdatedFinancialRecordDirectionEnum = {
    In: 'IN',
    Out: 'OUT'
};
/**
 ...
 */
function instanceOfFinancialRecordRadarItemsPageDtoItemsInnerAutoExecutePartialUpdatedFinancialRecord(value) {
...
function FinancialRecordRadarItemsPageDtoItemsInnerAutoExecutePartialUpdatedFinancialRecordFromJSON(json) {
    return FinancialRecordRadarItemsPageDtoItemsInnerAutoExecutePartialUpdatedFinancialRecordFromJSONTyped(json, false);
}
function FinancialRecordRadarItemsPageDtoItemsInnerAutoExecutePartialUpdatedFinancialRecordFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function FinancialRecordRadarItemsPageDtoItemsInnerAutoExecutePartialUpdatedFinancialRecordToJSON(json) {
    return FinancialRecordRadarItemsPageDtoItemsInnerAutoExecutePartialUpdatedFinancialRecordToJSONTyped(json, false);
}
function FinancialRecordRadarItemsPageDtoItemsInnerAutoExecutePartialUpdatedFinancialRecordToJSONTyped(value, ignoreDiscriminator) {
