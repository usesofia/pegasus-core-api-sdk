...
exports.FinancialRecordDtoDirectionEnum = void 0;
exports.instanceOfFinancialRecordDto = instanceOfFinancialRecordDto;
exports.FinancialRecordDtoFromJSON = FinancialRecordDtoFromJSON;
exports.FinancialRecordDtoFromJSONTyped = FinancialRecordDtoFromJSONTyped;
exports.FinancialRecordDtoToJSON = FinancialRecordDtoToJSON;
exports.FinancialRecordDtoToJSONTyped = FinancialRecordDtoToJSONTyped;
 ...
 */
function instanceOfFinancialRecordDto(value) {
...
function FinancialRecordDtoFromJSON(json) {
    return FinancialRecordDtoFromJSONTyped(json, false);
}
function FinancialRecordDtoFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function FinancialRecordDtoToJSONTyped(value, ignoreDiscriminator) {
