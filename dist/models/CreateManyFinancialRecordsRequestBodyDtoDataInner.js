...
exports.CreateManyFinancialRecordsRequestBodyDtoDataInnerDirectionEnum = void 0;
exports.instanceOfCreateManyFinancialRecordsRequestBodyDtoDataInner = instanceOfCreateManyFinancialRecordsRequestBodyDtoDataInner;
exports.CreateManyFinancialRecordsRequestBodyDtoDataInnerFromJSON = CreateManyFinancialRecordsRequestBodyDtoDataInnerFromJSON;
exports.CreateManyFinancialRecordsRequestBodyDtoDataInnerFromJSONTyped = CreateManyFinancialRecordsRequestBodyDtoDataInnerFromJSONTyped;
exports.CreateManyFinancialRecordsRequestBodyDtoDataInnerToJSON = CreateManyFinancialRecordsRequestBodyDtoDataInnerToJSON;
 ...
 * @export
 */
exports.CreateManyFinancialRecordsRequestBodyDtoDataInnerDirectionEnum = {
    In: 'IN',
    Out: 'OUT'
};
/**
 ...
 */
function instanceOfCreateManyFinancialRecordsRequestBodyDtoDataInner(value) {
...
function CreateManyFinancialRecordsRequestBodyDtoDataInnerFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function CreateManyFinancialRecordsRequestBodyDtoDataInnerToJSON(json) {
    return CreateManyFinancialRecordsRequestBodyDtoDataInnerToJSONTyped(json, false);
}
function CreateManyFinancialRecordsRequestBodyDtoDataInnerToJSONTyped(value, ignoreDiscriminator) {
