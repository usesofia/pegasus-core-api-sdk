...
exports.InboxRecordEntityAutoExecuteLinkedFinancialRecordDirectionEnum = void 0;
exports.instanceOfInboxRecordEntityAutoExecuteLinkedFinancialRecord = instanceOfInboxRecordEntityAutoExecuteLinkedFinancialRecord;
exports.InboxRecordEntityAutoExecuteLinkedFinancialRecordFromJSON = InboxRecordEntityAutoExecuteLinkedFinancialRecordFromJSON;
exports.InboxRecordEntityAutoExecuteLinkedFinancialRecordFromJSONTyped = InboxRecordEntityAutoExecuteLinkedFinancialRecordFromJSONTyped;
exports.InboxRecordEntityAutoExecuteLinkedFinancialRecordToJSON = InboxRecordEntityAutoExecuteLinkedFinancialRecordToJSON;
exports.InboxRecordEntityAutoExecuteLinkedFinancialRecordToJSONTyped = InboxRecordEntityAutoExecuteLinkedFinancialRecordToJSONTyped;
 ...
 * @export
 */
exports.InboxRecordEntityAutoExecuteLinkedFinancialRecordDirectionEnum = {
    Income: 'INCOME',
    Outcome: 'OUTCOME'
};
/**
 ...
 */
function instanceOfInboxRecordEntityAutoExecuteLinkedFinancialRecord(value) {
...
function InboxRecordEntityAutoExecuteLinkedFinancialRecordFromJSON(json) {
    return InboxRecordEntityAutoExecuteLinkedFinancialRecordFromJSONTyped(json, false);
}
function InboxRecordEntityAutoExecuteLinkedFinancialRecordFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function InboxRecordEntityAutoExecuteLinkedFinancialRecordToJSON(json) {
    return InboxRecordEntityAutoExecuteLinkedFinancialRecordToJSONTyped(json, false);
}
function InboxRecordEntityAutoExecuteLinkedFinancialRecordToJSONTyped(value, ignoreDiscriminator) {
