...
exports.FinancialRecordRadarItemEntityExtractedFinancialRecordDataDirectionEnum = void 0;
exports.instanceOfFinancialRecordRadarItemEntityExtractedFinancialRecordData = instanceOfFinancialRecordRadarItemEntityExtractedFinancialRecordData;
exports.FinancialRecordRadarItemEntityExtractedFinancialRecordDataFromJSON = FinancialRecordRadarItemEntityExtractedFinancialRecordDataFromJSON;
exports.FinancialRecordRadarItemEntityExtractedFinancialRecordDataFromJSONTyped = FinancialRecordRadarItemEntityExtractedFinancialRecordDataFromJSONTyped;
exports.FinancialRecordRadarItemEntityExtractedFinancialRecordDataToJSON = FinancialRecordRadarItemEntityExtractedFinancialRecordDataToJSON;
exports.FinancialRecordRadarItemEntityExtractedFinancialRecordDataToJSONTyped = FinancialRecordRadarItemEntityExtractedFinancialRecordDataToJSONTyped;
 ...
 * @export
 */
exports.FinancialRecordRadarItemEntityExtractedFinancialRecordDataDirectionEnum = {
    In: 'IN',
    Out: 'OUT'
};
/**
 ...
 */
function instanceOfFinancialRecordRadarItemEntityExtractedFinancialRecordData(value) {
    return true;
}
function FinancialRecordRadarItemEntityExtractedFinancialRecordDataFromJSON(json) {
    return FinancialRecordRadarItemEntityExtractedFinancialRecordDataFromJSONTyped(json, false);
}
function FinancialRecordRadarItemEntityExtractedFinancialRecordDataFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function FinancialRecordRadarItemEntityExtractedFinancialRecordDataToJSON(json) {
    return FinancialRecordRadarItemEntityExtractedFinancialRecordDataToJSONTyped(json, false);
}
function FinancialRecordRadarItemEntityExtractedFinancialRecordDataToJSONTyped(value, ignoreDiscriminator) {
