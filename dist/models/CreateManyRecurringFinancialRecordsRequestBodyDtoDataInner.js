...
exports.CreateManyRecurringFinancialRecordsRequestBodyDtoDataInnerFrequencyEnum = exports.CreateManyRecurringFinancialRecordsRequestBodyDtoDataInnerDirectionEnum = void 0;
exports.instanceOfCreateManyRecurringFinancialRecordsRequestBodyDtoDataInner = instanceOfCreateManyRecurringFinancialRecordsRequestBodyDtoDataInner;
exports.CreateManyRecurringFinancialRecordsRequestBodyDtoDataInnerFromJSON = CreateManyRecurringFinancialRecordsRequestBodyDtoDataInnerFromJSON;
exports.CreateManyRecurringFinancialRecordsRequestBodyDtoDataInnerFromJSONTyped = CreateManyRecurringFinancialRecordsRequestBodyDtoDataInnerFromJSONTyped;
exports.CreateManyRecurringFinancialRecordsRequestBodyDtoDataInnerToJSON = CreateManyRecurringFinancialRecordsRequestBodyDtoDataInnerToJSON;
exports.CreateManyRecurringFinancialRecordsRequestBodyDtoDataInnerToJSONTyped = CreateManyRecurringFinancialRecordsRequestBodyDtoDataInnerToJSONTyped;
 ...
 * @export
 */
exports.CreateManyRecurringFinancialRecordsRequestBodyDtoDataInnerDirectionEnum = {
    In: 'IN',
    Out: 'OUT'
};
/**
 * @export
 */
exports.CreateManyRecurringFinancialRecordsRequestBodyDtoDataInnerFrequencyEnum = {
    Weekly: 'WEEKLY',
    Monthly: 'MONTHLY',
    Yearly: 'YEARLY'
};
 ...
 */
function instanceOfCreateManyRecurringFinancialRecordsRequestBodyDtoDataInner(value) {
...
function CreateManyRecurringFinancialRecordsRequestBodyDtoDataInnerFromJSON(json) {
    return CreateManyRecurringFinancialRecordsRequestBodyDtoDataInnerFromJSONTyped(json, false);
}
function CreateManyRecurringFinancialRecordsRequestBodyDtoDataInnerFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function CreateManyRecurringFinancialRecordsRequestBodyDtoDataInnerToJSONTyped(value, ignoreDiscriminator) {
