...
# SystemFinancialRecordsPageDtoItemsInner
...
```typescript
import type { SystemFinancialRecordsPageDtoItemsInner } from '@usesofia/pegasus-core-api-sdk'
...
const exampleParsed = JSON.parse(exampleJSON) as SystemFinancialRecordsPageDtoItemsInner
