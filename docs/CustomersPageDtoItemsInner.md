...
```typescript
import type { CustomersPageDtoItemsInner } from '@usesofia/pegasus-core-api-sdk'
...
} satisfies CustomersPageDtoItemsInner
...
const exampleParsed = JSON.parse(exampleJSON) as CustomersPageDtoItemsInner
