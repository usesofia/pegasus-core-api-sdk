...
# FinancialRecordRadarItemEntityAutoExecutePartialUpdatedFinancialRecord
...
```typescript
import type { FinancialRecordRadarItemEntityAutoExecutePartialUpdatedFinancialRecord } from '@usesofia/pegasus-core-api-sdk'
...
const example = {
  ...
  "importedAt": null,
  "importedBy": null,
} satisfies FinancialRecordRadarItemEntityAutoExecutePartialUpdatedFinancialRecord
...
const exampleParsed = JSON.parse(exampleJSON) as FinancialRecordRadarItemEntityAutoExecutePartialUpdatedFinancialRecord
