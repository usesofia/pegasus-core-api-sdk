...
# FinancialRecordRadarItemsPageDtoItemsInnerAutoExecuteCreatedFinancialRecord
...
```typescript
import type { FinancialRecordRadarItemsPageDtoItemsInnerAutoExecuteCreatedFinancialRecord } from '@usesofia/pegasus-core-api-sdk'
...
const example = {
  ...
  "externalId": null,
} satisfies FinancialRecordRadarItemsPageDtoItemsInnerAutoExecuteCreatedFinancialRecord
...
const exampleParsed = JSON.parse(exampleJSON) as FinancialRecordRadarItemsPageDtoItemsInnerAutoExecuteCreatedFinancialRecord
