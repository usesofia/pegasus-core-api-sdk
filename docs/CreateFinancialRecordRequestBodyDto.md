...
```typescript
import type { CreateFinancialRecordRequestBodyDto } from '@usesofia/pegasus-core-api-sdk'
...
const example = {
  ...
  "radarItem": null,
  "channel": null,
} satisfies CreateFinancialRecordRequestBodyDto
...
const exampleParsed = JSON.parse(exampleJSON) as CreateFinancialRecordRequestBodyDto
