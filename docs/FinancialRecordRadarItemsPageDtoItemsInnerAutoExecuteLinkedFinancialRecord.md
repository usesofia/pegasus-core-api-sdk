...
# FinancialRecordRadarItemsPageDtoItemsInnerAutoExecuteLinkedFinancialRecord
...
```typescript
import type { FinancialRecordRadarItemsPageDtoItemsInnerAutoExecuteLinkedFinancialRecord } from '@usesofia/pegasus-core-api-sdk'
...
const exampleParsed = JSON.parse(exampleJSON) as FinancialRecordRadarItemsPageDtoItemsInnerAutoExecuteLinkedFinancialRecord
