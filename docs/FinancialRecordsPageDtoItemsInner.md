...
# FinancialRecordsPageDtoItemsInner
...
```typescript
import type { FinancialRecordsPageDtoItemsInner } from '@usesofia/pegasus-core-api-sdk'
...
} satisfies FinancialRecordsPageDtoItemsInner
...
const exampleParsed = JSON.parse(exampleJSON) as FinancialRecordsPageDtoItemsInner
