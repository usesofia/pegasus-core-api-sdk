...
```typescript
import type { PartialUpdateFinancialRecordRequestBodyDto } from '@usesofia/pegasus-core-api-sdk'
...
const exampleParsed = JSON.parse(exampleJSON) as PartialUpdateFinancialRecordRequestBodyDto
