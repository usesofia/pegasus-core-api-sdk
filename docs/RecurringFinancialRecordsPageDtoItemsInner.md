...
# RecurringFinancialRecordsPageDtoItemsInner
...
```typescript
import type { RecurringFinancialRecordsPageDtoItemsInner } from '@usesofia/pegasus-core-api-sdk'
...
const example = {
  ...
  "observations": null,
  "searchScore": null,
} satisfies RecurringFinancialRecordsPageDtoItemsInner
...
const exampleParsed = JSON.parse(exampleJSON) as RecurringFinancialRecordsPageDtoItemsInner
