...
# CreatedFinancialRecordRadarItemResultEntityAutoExecutePartialUpdatedFinancialRecord
...
```typescript
import type { CreatedFinancialRecordRadarItemResultEntityAutoExecutePartialUpdatedFinancialRecord } from '@usesofia/pegasus-core-api-sdk'
...
} satisfies CreatedFinancialRecordRadarItemResultEntityAutoExecutePartialUpdatedFinancialRecord
...
const exampleParsed = JSON.parse(exampleJSON) as CreatedFinancialRecordRadarItemResultEntityAutoExecutePartialUpdatedFinancialRecord
