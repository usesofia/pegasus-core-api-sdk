...
# CreatedFinancialRecordRadarItemResultEntityRadarItemAutoExecuteLinkedFinancialRecord
...
```typescript
import type { CreatedFinancialRecordRadarItemResultEntityRadarItemAutoExecuteLinkedFinancialRecord } from '@usesofia/pegasus-core-api-sdk'
...
const example = {
  ...
  "searchScore": null,
} satisfies CreatedFinancialRecordRadarItemResultEntityRadarItemAutoExecuteLinkedFinancialRecord
...
const exampleParsed = JSON.parse(exampleJSON) as CreatedFinancialRecordRadarItemResultEntityRadarItemAutoExecuteLinkedFinancialRecord
