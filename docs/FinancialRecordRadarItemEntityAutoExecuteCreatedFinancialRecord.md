...
# FinancialRecordRadarItemEntityAutoExecuteCreatedFinancialRecord
...
```typescript
import type { FinancialRecordRadarItemEntityAutoExecuteCreatedFinancialRecord } from '@usesofia/pegasus-core-api-sdk'
...
const example = {
  ...
  "searchScore": null,
} satisfies FinancialRecordRadarItemEntityAutoExecuteCreatedFinancialRecord
...
const exampleParsed = JSON.parse(exampleJSON) as FinancialRecordRadarItemEntityAutoExecuteCreatedFinancialRecord
