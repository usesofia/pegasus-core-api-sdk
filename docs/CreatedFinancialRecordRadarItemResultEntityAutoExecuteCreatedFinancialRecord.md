...
# CreatedFinancialRecordRadarItemResultEntityAutoExecuteCreatedFinancialRecord
...
```typescript
import type { CreatedFinancialRecordRadarItemResultEntityAutoExecuteCreatedFinancialRecord } from '@usesofia/pegasus-core-api-sdk'
...
const example = {
  ...
  "importedAt": null,
  "importedBy": null,
} satisfies CreatedFinancialRecordRadarItemResultEntityAutoExecuteCreatedFinancialRecord
...
const exampleParsed = JSON.parse(exampleJSON) as CreatedFinancialRecordRadarItemResultEntityAutoExecuteCreatedFinancialRecord
