...
# CreatedFinancialRecordRadarItemResultEntityRadarItemAutoExecuteCreatedFinancialRecord
...
```typescript
import type { CreatedFinancialRecordRadarItemResultEntityRadarItemAutoExecuteCreatedFinancialRecord } from '@usesofia/pegasus-core-api-sdk'
...
} satisfies CreatedFinancialRecordRadarItemResultEntityRadarItemAutoExecuteCreatedFinancialRecord
...
const exampleParsed = JSON.parse(exampleJSON) as CreatedFinancialRecordRadarItemResultEntityRadarItemAutoExecuteCreatedFinancialRecord
