...
# FinancialRecordRadarItemEntityAutoExecuteLinkedFinancialRecord
...
```typescript
import type { FinancialRecordRadarItemEntityAutoExecuteLinkedFinancialRecord } from '@usesofia/pegasus-core-api-sdk'
...
} satisfies FinancialRecordRadarItemEntityAutoExecuteLinkedFinancialRecord
...
const exampleParsed = JSON.parse(exampleJSON) as FinancialRecordRadarItemEntityAutoExecuteLinkedFinancialRecord
