 ...
 * @export
 */
export const InboxRecordEntityAutoExecutePartialUpdatedFinancialRecordDirectionEnum = {
    Income: 'INCOME',
    Outcome: 'OUTCOME'
} as const;
 ...
 */
export function instanceOfInboxRecordEntityAutoExecutePartialUpdatedFinancialRecord(value: object): value is InboxRecordEntityAutoExecutePartialUpdatedFinancialRecord {
...
export function InboxRecordEntityAutoExecutePartialUpdatedFinancialRecordFromJSON(json: any): InboxRecordEntityAutoExecutePartialUpdatedFinancialRecord {
    return InboxRecordEntityAutoExecutePartialUpdatedFinancialRecordFromJSONTyped(json, false);
}

export function InboxRecordEntityAutoExecutePartialUpdatedFinancialRecordFromJSONTyped(json: any, ignoreDiscriminator: boolean): InboxRecordEntityAutoExecutePartialUpdatedFinancialRecord {
    if (json == null) {
        return json;
    }
    return {
...
export function InboxRecordEntityAutoExecutePartialUpdatedFinancialRecordToJSON(json: any): InboxRecordEntityAutoExecutePartialUpdatedFinancialRecord {
    return InboxRecordEntityAutoExecutePartialUpdatedFinancialRecordToJSONTyped(json, false);
}

export function InboxRecordEntityAutoExecutePartialUpdatedFinancialRecordToJSONTyped(value?: InboxRecordEntityAutoExecutePartialUpdatedFinancialRecord | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
