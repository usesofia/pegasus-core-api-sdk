...
export interface ContactEntity {
     ...
     * @memberof ContactEntity
     */
    createdByChannel: ContactEntityCreatedByChannelEnum;
    /**
     * Nome do contato.
     * @type {string}
     * @memberof ContactEntity
 ...
 * @export
 */
export const ContactEntityCreatedByChannelEnum = {
    WebApp: 'WEB_APP',
    Whatsapp: 'WHATSAPP'
} as const;
export type ContactEntityCreatedByChannelEnum = typeof ContactEntityCreatedByChannelEnum[keyof typeof ContactEntityCreatedByChannelEnum];
